<?php
	...
	$sql = "SELECT device_id, fav, type, temp, humi, open, co, co2, sec, loca_id, DATE_FORMAT(timestamp, '%H:%i:%s') as time FROM home WHERE fav=1";
...
?>
	...
	<div class="card mb-3">
        <div style="text-align:center;" class="card-header">
         <i class="fa fa-star yellow-bg" id="demo" style="cursor: pointer; color: #ffcc00;" onclick="editFav('<?php echo($row["device_id"]) ?>')"></i><strong> <?php echo($row2["rm_name"]) ?></strong> 
        </div>
